"""
Convert Qwen3-ASR-0.6B audio encoder to NCNN fp16 with pnnx.

The exported model is only the audio encoder:
    mel features [1, 128, frames] -> audio embeddings [1, S, 1024]

The full ASR pipeline still needs preprocessing, tokenizer, prompt handling,
and text decoder logic outside this NCNN encoder.
"""
...
BASE_NAME = "qwen3_asr_0_6b_audio_encoder"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export Qwen3-ASR-0.6B audio encoder to NCNN fp16.")
...
def main() -> int:
    ...
    print("=" * 72)
    print("Qwen3-ASR-0.6B audio encoder -> TorchScript -> pnnx -> NCNN fp16")
